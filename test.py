...
police_to_evaluate = {1: "newenv18_actionspace_models/95k_add__8194_steps.zip",
...
for x, name in police_to_evaluate.items():
    ...
    mean_reward, std_reward = evaluate_policy(model, model.get_env(), n_eval_episodes=45, return_episode_rewards=False,
                                              deterministic=True)
